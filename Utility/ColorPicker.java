...
public class ColorPicker 
{
  ...
  private static final ColorPickerConstraint DefaultColorPickerConstraint = new ColorPickerConstraint();
  ...
  {
    return RandomColor(DefaultColorPickerConstraint);
  }

  public static Color RandomColor(ColorPickerConstraint colorPickerConstraint)
  {
    float h = (float) (colorPickerConstraint.MinHue + (colorPickerConstraint.MaxHue - colorPickerConstraint.MinHue) * DefaultRandomGenerator.Value());
    float s = (float) (colorPickerConstraint.MinSaturation + (colorPickerConstraint.MaxSaturation - colorPickerConstraint.MinSaturation) * DefaultRandomGenerator.Value());
    float b = (float) (colorPickerConstraint.MinBrightness + (colorPickerConstraint.MaxBrightness - colorPickerConstraint.MinBrightness) * DefaultRandomGenerator.Value());
  ...
  {
    return RandomColors(DefaultColorPickerConstraint, count);
  }
  
  public static Color[] RandomColors(ColorPickerConstraint colorPickerConstraint, int count)
  {
    return RandomColors(colorPickerConstraint, ColorScheme.None, count);
  }

  public static Color[] RandomColors(ColorScheme scheme, int count)
  {
    return RandomColors(DefaultColorPickerConstraint, scheme, count);
  }

  public static Color[] RandomColors(ColorPickerConstraint colorPickerConstraint, ColorScheme scheme, int count)
  {
    ...
    if (scheme == ColorScheme.None)
    {
      ...
      {
        colors[i] = RandomColor(colorPickerConstraint);
      }
      return colors;
    }
    
    var base = RandomColor(colorPickerConstraint);
    ...
    switch (scheme) 
    {
      ...
      //     h -= (float)Utility.Math.ToRadians(60f);
      //     var step = (float)Utility.Math.ToRadians(120f / (count - 1));

      //     for (var i = 0; i < count; i++) 
      //     {
      //       colors[i] = Color.FromHsb(h, s, b);
      //       h += step;
      //       hb = h * 360f;
      //     }
      //   }
      ...
      default:
        {
          var h = base.HueInt();
          var s = base.SaturationInt();
          var b = base.BrightnessInt();
          h -= 60;
          var step = 120f / (count - 1);
