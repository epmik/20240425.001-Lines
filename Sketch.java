...
{
  private boolean _reDrawBackground = true;
  ...
  public LinearGradientBackground LinearGradientBackground;
  private RandomPixelDisplacePass _pixelDisplacePass = null;
  ...
  private void SetupColorsBackgroundAndRadialGradient()
  {
    ...
    if (LinearGradientBackground == null) 
    {
      Background = LinearGradientBackground = new LinearGradientBackground();
    } 
    else 
    {
      LinearGradientBackground.Gradient.Clear();
    }
    ...
    {
      LinearGradientBackground.Gradient.Insert(time, colors[i]);

      time += step;
    }

    LinearGradientBackground.Gradient.Insert(1f, colors[colors.length - 1]);
    ...
    RadialGradient.Insert(0f, LinearGradientBackground.Gradient.RandomColor(0f, 1f));
    RadialGradient.Insert(Graphics.height * 0.5f, LinearGradientBackground.Gradient.RandomColor(0f, 1f));
    ...
    _radialBurstGradient.Insert(1f, LinearGradientBackground.Gradient.RandomColor(0f, 1f));
  ...
  public void setup() 
  {
    ...
    _pixelDisplacePass = new RandomPixelDisplacePass(Graphics);
    _pixelDisplacePass.MinHorizontalDisplaceAmount = -100;
    _pixelDisplacePass.MaxHorizontalDisplaceAmount = 100;
    _pixelDisplacePass.MinVerticalDisplaceAmount = -100;
    _pixelDisplacePass.MaxVerticalDisplaceAmount = 100;
  ...
  public void draw() 
  {
    ...
    if(_reDrawBackground)
    {
      ...
      _pixelDisplacePass.Apply(Graphics, Graphics);
  
      _reDrawBackground = false;
    }  
